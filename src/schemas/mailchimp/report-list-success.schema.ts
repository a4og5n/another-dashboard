...
export const ReportListStatsSchema = z.object({
  ...
  proxy_excluded_open_rate: z.number().min(0).max(100),
...
export const CampaignReportSchema = z.object({
  ...
  rss_last_send: z.string(), // ISO 8601 format
  ...
  ab_split: ReportAbSplitSchema,
  timewarp: ReportTimewarpSchema,
  timeseries: ReportTimeseriesSchema,
