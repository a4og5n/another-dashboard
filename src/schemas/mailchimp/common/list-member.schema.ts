/**
 * Common List Member Schema
 * Reusable schema for list member objects across multiple endpoints
 *
 * Used by:
 * - GET /lists/{list_id}/members (List Members)
 * - GET /lists/{list_id}/members/{subscriber_hash} (Get Member Info)
 * - GET /search-members (Search Members - future)
 * - And other member-related endpoints
 *
 ...
 *
 * This is a common schema used across multiple endpoints that return
 * member information. It includes all possible fields that may be returned
 * by the Mailchimp API for a list member.
 */
