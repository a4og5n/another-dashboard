...
import { MailchimpLinkSchema, HTTP_METHODS } from "@/schemas/mailchimp/common/link.schema";

/**
 * Mailchimp Error Response Type
 * Inferred from error response schema - includes all 5 fields
 */
export type MailchimpErrorResponse = z.infer<typeof mailchimpErrorResponseSchema>;
