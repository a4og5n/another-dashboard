/**
 * Campaign Email Activity Not Found Page
 * 404 UI for campaign email activity route
 */
    ...
    <div className="min-h-screen bg-background">
      ...
      <BreadcrumbNavigation
        items={[
          ...
          { label: "Report", href: "#" },
          { label: "Email Activity", isCurrent: true },
        ]}
      />
      ...
      <div className="container mx-auto pb-8 px-6 flex items-center justify-center min-h-[60vh]">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>Campaign Email Activity Not Found</CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              The campaign email activity data you&apos;re looking for
