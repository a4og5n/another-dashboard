/**
 * Campaign Abuse Reports Not Found Page
 * 404 UI for campaign abuse reports route
 */
      ...
      <div className="container mx-auto pb-8 px-6 flex items-center justify-center min-h-[60vh]">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>Abuse Reports Not Found</CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-muted-foreground">
              The abuse reports data you&apos;re looking for doesn&apos;t exist
              or may have been removed. This could happen if the campaign ID is
              invalid or the campaign doesn&apos;t have any abuse reports.
            </p>
