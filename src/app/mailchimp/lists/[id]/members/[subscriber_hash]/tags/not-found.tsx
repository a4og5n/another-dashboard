/**
 * Member Tags Not Found Page
 * Displayed when the requested member or tags cannot be found
 */
...
export default function NotFound() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Member Tags Not Found</CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          The requested member or their tags could not be found.
        </p>
